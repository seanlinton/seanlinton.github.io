 ...
 */
                ...
                Obj.prototype.initStyle = function() {
                    ...
                    s.top = s.left = 0;
                    s.width = a - c * 2 + 'rem';
                    var d = s.height = b - c * 2 + 'rem';
                    s.background = this.opts.c;
                    s.backgroundSize = 'cover';
                    s.border = c + 'rem solid ' + this.opts.borderColor;
                    s.opacity = this.opts.opa;
                    if (this.opts.html) {
                        this.opts.e.innerHTML = this.opts.html;
                        s.textAlign = 'center';
                        s.lineHeight = d;
                        s.fontSize = this.opts.fontSize + 'rem'
                    }
                    this.setPos()
                };
                ...
                Obj.prototype.setPos = function() {
                    ...
                    this.opts.e.style.transform = 'translate(' + x + 'rem,' + y + 'rem)';
                    this.opts.e.style.webkitTransform = 'translate(' + x + 'rem,' + y + 'rem)'
                };
                ...
                Obj.prototype.setBorderWidth = function(n) {
                    ...
                    var a = n * 2;
                    var s = this.opts.e.style;
                    s.width = parseInt(this.opts.width - a) + 'rem';
                    var b = s.height = parseInt(this.opts.height - a) + 'rem';
                    s.lineHeight = b;
                    s.border = n + 'rem solid ' + this.opts.borderColor
                };
                Obj.prototype.setBorderColor = function(a) {
                    var a = this.opts.borderColor = a;
                    this.opts.e.style.border = this.opts.borderWidth + 'rem solid ' + a
                };
                ...
                Obj.prototype.setHTML = function(a) {
                    ...
                    s.textAlign = 'center';
                    s.lineHeight = this.opts.height - this.opts.borderWidth * 2 + 'rem';
                    s.fontSize = this.opts.fontSize + 'rem'
                };
                ...
                Ball.prototype.setB = function(n) {
                    ...
                    s.width = s.height = (b - this.opts.borderWidth) * 2 + 'rem';
                    s.lineHeight = (b - this.opts.borderWidth) * 2 + 'rem';
                    this.setPos()
                };